...
import PhoneCallQrGenerator from "../components/PhoneCallQrGenerator";

const PhoneCallQRGeneratorPage = () => {
  useEffect(() => {
    document.title = "Phone Call QR Code Generator | QR Code Llama";
  }, []);
...
export default PhoneCallQRGeneratorPage;
