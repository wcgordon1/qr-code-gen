...
import TextMessageQRGenerator from "../components/TextMessageQRGenerator";

const TextMessageQRGeneratorPage = () => {
  useEffect(() => {
    document.title = "Text Message QR Code Generator | QR Code Llama";
  }, []);
...
export default TextMessageQRGeneratorPage;
